/**
 * Статичный контент сайта — разделы каталога, бренды, реквизиты, блок
 * преимуществ. Ни один экспорт здесь не зависит от catalog.json: это ровно
 * то, что нужно шапке и главной странице для первой отрисовки, и раздувать
 * их 422 КБ описаний всех 135 позиций незачем — эти данные грузит только
 * страница каталога, когда до неё доходит дело.
 */
